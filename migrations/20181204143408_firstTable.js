...
exports.down = function (knex, Promise) {
   //return knex.schema;
   return knex.schema.dropTable('attractioninplan').dropTable('plan').dropTable('attractioncomment').dropTable('bookmark').dropTable('attraction').dropTable('usersubmitattraction').dropTable('users').dropTable('city');
};
