  ...
  return knex('attractioncomment').del()
    .then(function () {
      ...
      return knex('attraction').insert([
        ...
        { cityid: 1, userid: 1, type: "restaurant", name: 'Sushi No Midori', description: 'Located near Shibuya Station, Sushi Nobu is like a secret getaway at the center of the city with a very relaxing atmosphere. They take great care in preparing their dishes. ', latitude: "35.6583", longitude: "139.6990", confirmstatus: "accept" },
