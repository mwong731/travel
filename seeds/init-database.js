  ...
  return knex('attractioncomment').del()
    .then(function () {
      ...
      return knex('users').insert([
        { email: "userman1@gmail.com", password: '$2b$10$LydDZMcaY05OVJ1HLS4uUudeOhiUFCKmFoq3gl.5WLBowancCA6gO', facebookid: '', googleid: '', name: 'userman1', gender: "Male", birthday: new Date(), usertype: "user", image: "" },
      ...
      return knex('attraction').insert([
        { cityid: 1, userid: 1, type: "go", name: 'Tokyo Tower', description: 'Tokyo Tower is a communications and observation tower in the Shiba-koen district of Minato, Tokyo, Japan. At 332.9 metres, it is the second-tallest structure in Japan. ', latitude: "35.6586", longitude: "39.7454", confirmstatus: "accept" },
        { cityid: 1, userid: 1, type: "go", name: 'Sensō-ji', description: "Sensō-ji is an ancient Buddhist temple located in Asakusa, Tokyo, Japan. It is Tokyo's oldest temple, and one of its most significant. Formerly associated with the Tendai sect of Buddhism, it became independent after World War II.", latitude: "35.7148", longitude: "139.7967", confirmstatus: "accept" },
        { cityid: 1, userid: 1, type: "restaurant", name: 'Hayashi Ramen', description: 'Hayashi has been the best ramen shop within easy walking distance of Shibuya Station since its debut in 2003.', latitude: "35.6573", longitude: "139.6980", confirmstatus: "accept" },
        { cityid: 1, userid: 1, type: "restaurant", name: 'Sushi No Midori', description: 'Located near Shibuya Station, Sushi Nobu is like a secret getaway at the center of the city with a very relaxing atmosphere. They take great care in preparing their dishes, including their highly recommended Pacific Bluefin Tuna, which can be served raw so that you can enjoy its exceptional taste. ', latitude: "35.6583", longitude: "139.6990", confirmstatus: "accept" },
        { cityid: 1, userid: 1, type: "shop", name: 'Journal Standard Relume', description: 'A clothing retail job description encompasses more duties than simply greeting and helping customers. A clothing store job description includes processing payments, handling the return of merchandise and bagging or packaging clothing.', latitude: "35.6068", longitude: "139.6693", confirmstatus: "accept" },

        { cityid: 2, userid: 2, type: "restaurant", name: 'restaurant2', description: 'description4', latitude: "22.313235", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 2, userid: 2, type: "restaurant", name: 'restaurant2', description: 'description4', latitude: "22.313235", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 2, userid: 2, type: "restaurant", name: 'restaurant2', description: 'description4', latitude: "22.313235", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 2, userid: 2, type: "restaurant", name: 'restaurant2', description: 'description4', latitude: "22.313235", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 2, userid: 2, type: "restaurant", name: 'restaurant2', description: 'description4', latitude: "22.313235", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 3, userid: 2, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        ...
        { cityid: 3, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 3, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 4, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 4, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 4, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 4, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
        { cityid: 4, userid: 1, type: "go", name: 'go1', description: 'description5', latitude: "393.292919", longitude: "114.041271", confirmstatus: "accept" },
