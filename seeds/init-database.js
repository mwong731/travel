  ...
  return knex('attractioncomment').del()
    .then(function () {
      ...
      return knex('attraction').insert([
        ...
        { cityid: 3, userid: 3, type: "restaurant", name: 'Ramen Danbo', description: 'The simple but delicious umami from the pork in infused in every strand of the noodles, giving it a distinct flavor.', latitude: "33.5917", longitude: "130.4207", confirmstatus: "accept", icon: "../assets/ramendanbo.jpg" },
      ...
      return knex('attractioninplan').insert([
        { planid: 1, attractionid: 1, day: 1, time: "day" },
        { planid: 1, attractionid: 2, day: 2, time: "night" },
        { planid: 1, attractionid: 3, day: 3, time: "night" },
        { planid: 1, attractionid: 4, day: 2, time: "night" }
      ]);
    }).then(function () {
      console.log('14');
